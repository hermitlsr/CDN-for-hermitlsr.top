...
var qrcodes = {
    'qq_donate'	:	'https://doc.hermitlsr.top/post/icon/qqQR.png',	// 二维码路径
    'alipay_donate'	:	'https://doc.hermitlsr.top/post/icon/AliPayQR.png',	// 支付宝二维码
    'alipay_donate_link'   :   'https://qr.alipay.com/fkx03277sywmqzbvpjow76',   // 支付宝二维码上的链接，必须换成自己的连接！！！手机点击会自动跳转到支付宝。
    'wechat_donate'	:	'https://doc.hermitlsr.top/post/icon/WeChanSQ.png'
};
