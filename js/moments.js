var requests_url = 'https://hexo-circle-of-friends-api-blue-phi.vercel.app/api'; //api地址
var orign_data = []; //api请求所得到的源数据
var maxnumber = 20; //页面展示文章数量
var addnumber = 20; //每次加载增加的篇数
...
var loadingCutom = '<img src="https://cdn.jsdelivr.net/gh/hermitlsr/image-for-hermitlsr.top/web/lazyload_saber3.gif" alt="加载中...">'
